function all() {
  ...
  useThis.functions.dataLoad = () => {
    ...
    // `https://api-fetch.victor01sp.com/get.php?url=${ encode }`
    //https://cuevana.biz/peliculas/page/1
    ...
    fetchWebElement(
      ...
      Array.from( $text.querySelectorAll('img') ).forEach( img => img.removeAttribute('src') )
      // console.log(__NEXT_DATA__.props.pageProps.movies);
    });
  };
