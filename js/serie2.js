...
function extractURLs(text) {
  ...
  // Ejecutar la expresión regular sobre el texto y devolver las coincidencias
  const urls = text.match(urlPattern);

  // Si no hay URLs, devolver un array vacío
  return urls ? urls : [];
}
...
addEventListener("DOMContentLoaded", () => {
  ...
  keys.array = searchParams.get("id")
    ? ["key-RfwNgjwVeLgKee7", "key-qCVDDxQ4q1Wnr5o", "key-7HbIa9IIQgtEjQM"]
    : ["key-EeqSpNOJkulRszU", "key-UOO23MW014kVXu", "key-qCVDDxQ4q1Wnr5o"];
